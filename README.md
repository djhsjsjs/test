...
- `STRIPE_PRICE_ID` — the recurring Stripe Price ID for DEALCHECK Premium, intended to be **$2.99/month**
...
Create a recurring monthly Price for **$2.99/month** and put its Price ID into:
...
The master specification's working commercial price is **$2.99/month** and is configurable through Stripe's Price ID.
